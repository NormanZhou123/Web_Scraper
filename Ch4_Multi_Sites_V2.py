...
class Content:    #Common base class for all articles/pages
    ...
    def print(self):     #Flexible printing function controls output
        print('URL: {}'.format(self.url))
        print('Title: {}'.format(self.title))
        print("Body:\n{}".format(self.body))


class Website:    #Contains information about website structure, not content but tags
...
class Crawler:
    ...
    def parse(self, site, url):    #Extract content from a given page URL
        bs = self.getPage(url)
        if bs is not None:
